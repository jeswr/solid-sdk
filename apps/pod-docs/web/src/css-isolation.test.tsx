...
// rollout #67/#68/#70).
//
// pod-docs RELAXED its CSS-leak workaround back to a BARE global `button {}` filled
// rule + a direct re-alias of the host's `--accent` / `--accent-ink` onto the
// app-shell tokens, because @jeswr/app-shell #80 made the shell SELF-ISOLATING.
// This test pins WHY that relaxation is safe so a future app-shell bump that
