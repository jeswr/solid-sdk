...
export function App() {
  ...
  // The @jeswr Solid browser extension owns the account surface when present (see
  // the header comment below). Shared hook from @jeswr/app-shell.
      ...
      <header className="app-header">
        ...
        <div className="app-header-actions">
          ...
          {/* When the browser extension is present it owns the account surface (its pinned
              ...
              But pod-mail still holds its OWN independent SessionProvider session here (it has
