...
//
// (pod-chat's vitest default env is `node` — see vitest.config.ts; this DOM
// render test opts into jsdom per-file via the pragma above, which MUST be the
// first line, matching the app's other component tests.)
//
...
describe("AppErrorBoundary (pod-chat adoption)", () => {
