...
//
// SessionProvider — the ONE place auth is wired for the Solid App Store static host.
...
//     so the OP shows "Solid App Store" on the consent screen instead of a throwaway
...
const sessionStore: SessionStore | null = indexedDbAvailable()
  ? new IndexedDbSessionStore({ dbName: "solid-app-store:sessions" })
  : null;
 ...
 */
const remembered = new RememberedAccount("solid-app-store:remembered-account");
