...
export type { DecisionRecordInput, EvaluatedDecisionRecord } from "./decision-record.js";
export { decisionRecord, decisionRecordJsonLd, recordEvaluation } from "./decision-record.js";
...
export { ACL, ACL_MODE_TO_ACTION, ACL_MODES, ACTION_IRI, type AclMode, CONFLICT_IRI, CONFLICT_STRATEGIES, type ConflictStrategy, DECISION_RECORD_INLINE_CONTEXT, DPV, LEFT_OPERAND_IRI, LEFT_OPERANDS, type LeftOperandName, ODRL, ODRL_ACTIONS, ODRL_GRANT_USE, ODRL_INLINE_CONTEXT, ODRL_NEXT_POLICY, ODRL_TRANSFER, ODRLD, ODRLD_ACTIVE_DUTY, ODRLD_CONFLICT, ODRLD_DECIDING_RULE, ODRLD_DECISION, ODRLD_DECISION_RECORD_CLASS, ODRLD_DELEGATED_UNDER, ODRLD_DELEGATION_DEPTH, ODRLD_EVALUATED_POLICY, ODRLD_FULFILLED, ODRLD_INLINE_CONTEXT_EXTENSION, ODRLD_ON_DUTY, ODRLD_PROFILE_IRI, ODRLD_REASON, ODRLD_REQUEST_ACTION, ODRLD_REQUEST_AGENT, ODRLD_REQUEST_PURPOSE, ODRLD_REQUEST_TARGET, ODRLD_REVOCATION_CLASS, ODRLD_REVOKED_POLICY, ODRLD_RULE_KIND, type OdrlActionName, OPERATOR_IRI, OPERATORS, type OperatorName, PROV, PROV_ACTED_ON_BEHALF_OF, PROV_ACTIVITY, PROV_AGENT, PROV_ASSOCIATION, PROV_ENDED_AT_TIME, PROV_GENERATED, PROV_HAD_PLAN, PROV_INLINE_CONTEXT, PROV_QUALIFIED_ASSOCIATION, PROV_STARTED_AT_TIME, PROV_USED, PROV_WAS_ASSOCIATED_WITH, PROV_WAS_ATTRIBUTED_TO, PROV_WAS_DERIVED_FROM, PROV_WAS_GENERATED_BY, VALID_ACTION_IRIS, XSD_BOOLEAN, XSD_DATETIME, } from "./vocab.js";
