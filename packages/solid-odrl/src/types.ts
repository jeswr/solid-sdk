...
//
// The plain-object ODRL policy model + the evaluation request-context/result
// types. These are the lossless, machine-readable shapes the builder lowers to RDF
// and the parser reads back — independent of the (verbose) IRIs. The RDF graph is
// the interchange form; these objects are the ergonomic in-memory form.
...
export interface RequestContext {
  ...
  readonly attributes?: Readonly<
    Record<string, string | number | boolean | ReadonlyArray<string | number>>
  >;
}
