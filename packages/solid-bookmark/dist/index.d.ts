 ...
 */
export { Bookmark, type BookmarkData, bookmarkSubject, buildBookmark, isHttpIri, parseBookmark, parseBookmarkTtl, serializeBookmark, storeToTurtle, } from "./bookmark.js";
export { BOOK, BOOK_ARCHIVED, BOOK_NOTES, BOOKMARK_CLASS, book, CORE, core, DCT, DCT_CREATED, DCT_DESCRIPTION, DCT_MODIFIED, DCT_TITLE, dct, PREFIXES, RDF, RDF_TYPE, RDFS, rdf, rdfs, SCHEMA, SCHEMA_KEYWORDS, SCHEMA_URL, SKOS, schema, skos, XSD, xsd, } from "./vocab.js";
