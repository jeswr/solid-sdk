...
import { BOOK_ARCHIVED, BOOK_NOTES, BOOKMARK_CLASS, DCT_CREATED, DCT_DESCRIPTION, DCT_MODIFIED, DCT_TITLE, PREFIXES, RDF_TYPE, SCHEMA_KEYWORDS, SCHEMA_URL, } from "./vocab.js";
...
export function bookmarkSubject(resourceUrl) {
 ...
 */
export function buildBookmark(resourceUrl, data) {
...
export function serializeBookmark(resourceUrl, data) {
 ...
 */
export function parseBookmark(resourceUrl, dataset) {
 ...
 */
export async function parseBookmarkTtl(resourceUrl, body, contentType = "text/turtle") {
