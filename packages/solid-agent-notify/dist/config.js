 ...
 */
export const FETCH_USER_AGENT = envStr("AGENT_NOTIFY_USER_AGENT", "solid-agent-notify/0.1 (+https://github.com/jeswr/solid-agent-notify; SSRF-guarded LDN client)");
/**
 ...
 */
export const FETCH_HOSTNAME_DENYLIST = envStr("AGENT_NOTIFY_HOSTNAME_DENYLIST", [
