...
const MONITOR = svgIcon('<rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/>');
...
export class JeswrThemeToggle extends LitElement {
    ...
    mql = null;
    onSystemChange = () => this.applyTheme(this.theme, false);
    static styles = [
        tokenStyles,
        css `
      :host {
