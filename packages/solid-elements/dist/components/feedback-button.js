...
import { buildIssueUrl, composeIssueBody, composeIssueTitle, FEEDBACK_CATEGORIES, feedbackLabels, } from "../feedback-core.js";
          ...
          ${this._phase === "success" && this._result
            ...
            : html `
                ...
                ? html `
                            <label class="consent">
                              <input
                                ...
                                @change=${(ev) => {
                    this._includeWebId = ev.target.checked;
                }}
                              />
                ...
                : nothing}
                    ...
                    <p class="diag">
                      We attach basic diagnostics: app name + version (${this.appName || "this app"}${versionLabel}) and the current page URL.
                    </p>
