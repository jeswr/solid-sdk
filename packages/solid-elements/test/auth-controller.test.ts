...
//
// Adapter-level regression tests for createReactiveAuthController, with
...
import type { LoginController } from "../src/login-controller.js";
...
const { createReactiveAuthController, MissingAuthFlowError, isUseDpopNonceChallenge } =
...
describe("createReactiveAuthController — dynamic registration metadata (Medium fix)", () => {
...
describe("createReactiveAuthController — login generation fence (Medium fix)", () => {
...
describe("createReactiveAuthController — logout is fail-closed (High fixes)", () => {
...
describe("createReactiveAuthController — silent-restore pointer gated on a durable credential (Medium fix)", () => {
...
describe("createReactiveAuthController — authFlow is OPTIONAL for restore-only usage (Low fix)", () => {
...
describe("createReactiveAuthController — the auth seam", () => {
...
describe("createReactiveAuthController — the token provider (origin gate + refresh)", () => {
...
describe("createReactiveAuthController — resource-server DPoP nonce (RFC 9449 §8, Medium fix)", () => {
