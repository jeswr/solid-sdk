...
export const draw = (local) => `${DRAW}${local}`;
...
export const DRAW_SCENE = namedNode(DRAW_SCENE_IRI);
/** `draw:sceneDocument` as an rdf-js `NamedNode`. */
export const DRAW_SCENE_DOCUMENT = namedNode(DRAW_SCENE_DOCUMENT_IRI);
/** `draw:schemaVersion` as an rdf-js `NamedNode`. */
export const DRAW_SCHEMA_VERSION = namedNode(DRAW_SCHEMA_VERSION_IRI);
/** `draw:viewBackgroundColor` as an rdf-js `NamedNode`. */
export const DRAW_VIEW_BACKGROUND_COLOR = namedNode(DRAW_VIEW_BACKGROUND_COLOR_IRI);
/** `draw:thumbnail` as an rdf-js `NamedNode`. */
export const DRAW_THUMBNAIL = namedNode(DRAW_THUMBNAIL_IRI);
/** `schema:CreativeWork` as an rdf-js `NamedNode`. */
export const SCHEMA_CREATIVE_WORK = namedNode(SCHEMA_CREATIVE_WORK_IRI);
/** `dct:title` as an rdf-js `NamedNode`. */
export const DCT_TITLE = namedNode(DCT_TITLE_IRI);
/** `dct:created` as an rdf-js `NamedNode`. */
export const DCT_CREATED = namedNode(DCT_CREATED_IRI);
/** `dct:modified` as an rdf-js `NamedNode`. */
export const DCT_MODIFIED = namedNode(DCT_MODIFIED_IRI);
/** `schema:about` as an rdf-js `NamedNode`. */
export const SCHEMA_ABOUT = namedNode(SCHEMA_ABOUT_IRI);
/** `prov:wasGeneratedBy` as an rdf-js `NamedNode`. */
export const PROV_WAS_GENERATED_BY = namedNode(PROV_WAS_GENERATED_BY_IRI);
/** The `rdf:type` predicate as an rdf-js `NamedNode`. */
export const RDF_TYPE = namedNode(RDF_TYPE_IRI);
/** `xsd:dateTime` datatype as an rdf-js `NamedNode`. */
export const XSD_DATE_TIME = namedNode(xsd("dateTime"));
/** `xsd:string` datatype as an rdf-js `NamedNode`. */
export const XSD_STRING = namedNode(xsd("string"));
/**
