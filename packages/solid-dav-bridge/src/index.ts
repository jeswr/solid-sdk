...
// --- re-export the consumed contact model type for callers ---
...
export {
  ...
  defaultContactSlug,
  defaultEventSlug,
  type ImportAddressBookOptions,
  type ImportCalendarOptions,
...
export {
  type MappedContact,
  type MappedEvent,
  type VcardToContactOptions,
  type VeventToEventOptions,
  vcardToContact,
  veventToEvent,
} from "./map.js";
