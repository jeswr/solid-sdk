...
function readStored(storageKey: string | null): Theme | null {
...
function persist(storageKey: string | null, theme: Theme): void {
 ...
 */
export function themeScript(storageKey = "app-shell-theme", attributeClass = "dark"): string {
