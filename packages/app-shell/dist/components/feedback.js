...
export function FeedbackDialog({ repo, appName, appVersion, webId, submit, open, onOpenChange, }) {
    ...
    return (_jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4", children: [_jsx("button", { type: "button", "aria-label": "Close feedback dialog", tabIndex: -1, "data-app-shell-control": "backdrop", className: "absolute inset-0 cursor-default bg-black/50", onClick: () => onOpenChange(false) }), _jsxs("div", { ref: dialogRef, role: "dialog", "aria-modal": "true", "aria-labelledby": titleId, tabIndex: -1, className: "relative w-full max-w-md rounded-lg border border-as-border bg-as-popover p-5 text-as-popover-foreground shadow-md outline-none", children: [_jsx("h2", { id: titleId, className: "text-base font-semibold", children: phase === "success" ? "Thanks for the feedback" : `Feedback on ${appName}` }), phase === "success" && result ? (_jsxs("div", { className: "mt-3 flex flex-col gap-3 text-sm", children: [_jsxs("p", { children: ["Thanks \u2014 tracked as", " ", _jsxs("a", { href: result.url, target: "_blank", rel: "noopener noreferrer", className: "font-medium underline", children: ["#", result.number] }), "."] }), _jsx("div", { className: "flex justify-end", children: _jsx(Button, { variant: "outline", onClick: () => onOpenChange(false), children: "Close" }) })] })) : (_jsxs("form", { className: "mt-3 flex flex-col gap-4", onSubmit: handleSubmit, children: [_jsxs("fieldset", { className: "flex flex-col gap-2 border-0 p-0", children: [_jsx("legend", { className: "mb-2 text-sm font-medium", children: "What is this about?" }), _jsx("div", { className: "flex gap-2", children: CATEGORIES.map(({ value, label, emoji, icon: Icon }) => {
                                            ...
                                            return (_jsxs("label", { htmlFor: id, "data-app-shell-control": "card", "data-selected": selected ? "" : undefined, className: [
                                                ...
                                                ].join(" "), children: [_jsx("input", { id: id, type: "radio", name: `${descId}-category`, value: value, checked: selected, onChange: () => setCategory(value), "data-app-shell-control": "", className: "sr-only" }), _jsx(Icon, { className: "size-4", "aria-hidden": "true" }), _jsxs("span", { children: [_jsx("span", { "aria-hidden": "true", children: emoji }), " ", label] })] }, value));
                                        }) })] }), _jsxs("div", { className: "flex flex-col gap-1.5", children: [_jsx("label", { htmlFor: descId, className: "text-sm font-medium", children: "Tell us more" }), _jsx("textarea", { id: descId, ref: textareaRef, required: true, value: description, onChange: (e) => setDescription(e.target.value), rows: 4, placeholder: "Describe the bug, idea, or question\u2026", "data-app-shell-control": "", className: "resize-y rounded-md border border-as-border bg-as-background px-3 py-2 text-sm outline-none focus-visible:ring-2 focus-visible:ring-as-ring" })] }), webId ? (_jsxs("label", { htmlFor: consentId, className: "flex items-start gap-2 text-sm", children: [_jsx("input", { id: consentId, type: "checkbox", checked: includeWebId, onChange: (e) => setIncludeWebId(e.target.checked), "data-app-shell-control": "", className: "mt-0.5" }), _jsx("span", { children: "Include my WebID so the maintainer can follow up" })] })) : null, _jsxs("p", { className: "text-xs text-as-muted-foreground", children: ["We attach basic diagnostics: app name + version (", appName, versionLabel, ") and the current page URL."] }), phase === "error" && errorMessage ? (_jsx("p", { role: "alert", className: "text-sm text-as-destructive", children: errorMessage })) : null, _jsxs("div", { className: "flex justify-end gap-2", children: [_jsx(Button, { variant: "ghost", onClick: () => onOpenChange(false), disabled: phase === "submitting", children: "Cancel" }), _jsx(Button, { variant: "outline", type: "submit", disabled: !description.trim() || phase === "submitting", children: phase === "submitting"
                                            ? "Sending…"
                                            : submit
                                                ? "Send feedback"
