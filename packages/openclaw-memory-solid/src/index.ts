...
export {
  ...
  type MemoryRecord,
  SolidMemoryAdapter,
  type SolidMemoryAdapterCommonOptions,
  type SolidMemoryAdapterOptions,
  type SolidMemoryStoreInput,
  type StoreOptions,
  type StoreResult,
} from "./core.js";
export {
  type ConfigSchema,
  type CreateOpenClawMemoryPluginOptions,
  createOpenClawMemoryPlugin,
  type JsonSchemaObject,
  type OpenClawMemoryPlugin,
  type OpenClawPluginApi,
  type OpenClawTool,
  type OpenClawToolResult,
  type SolidMemoryPluginConfig,
} from "./plugin.js";
