 ...
 */
export declare function assertSubjectSingletons(dataset: DatasetCore, subject: string, singletonPredicates: readonly string[]): void;
//# sourceMappingURL=rdfGuards.d.ts.map