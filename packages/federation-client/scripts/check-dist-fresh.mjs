 ...
 * JavaScript + declarations against the committed `dist/`.
 *
 ...
 * a consumer importing the package. Code (`.js`) and types (`.d.ts`) are what
 * matter.
 *
...
let scratch;
try {
  scratch = mkdtempSync(join(tmpdir(), "fedclient-dist-"));
