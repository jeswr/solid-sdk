...
//
// Public domain types for the Solid agent-pointer surface: the plain-object
// views the builder/discoverer/validator exchange. The RDF itself is read/written
// through @rdfjs/wrapper typed accessors (never these objects directly) — these
// are the SDK's ergonomic surface.
