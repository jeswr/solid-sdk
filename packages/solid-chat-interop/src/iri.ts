 ...
 */
export function httpIriOrUndefined(value: unknown): string | undefined {
 ...
 */
export function toIsoOrUndefined(d: Date | undefined): string | undefined {
 ...
 */
export function tryRead<T>(read: () => T | undefined): T | undefined {
  try {
    return read();
  } catch {
    return undefined;
 ...
 * whole parse.
 */
export function readIsoDate(read: () => Date | undefined): string | undefined {
