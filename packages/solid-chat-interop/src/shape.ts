...
export const MESSAGE_SHAPE_PATH: string = fileURLToPath(
  new URL("../shapes/message.shacl.ttl", import.meta.url),
);
 ...
 * its shape.
 */
export function messageShapeTtl(): string {
  if (cachedMessage === undefined) cachedMessage = readFileSync(MESSAGE_SHAPE_PATH, "utf8");
