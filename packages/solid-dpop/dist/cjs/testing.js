...
exports.driveHeadlessOidc = driveHeadlessOidc;
exports.headlessLogin = headlessLogin;
/**
...
const authCode_js_1 = require("./authCode.js");
/**
 ...
 */
async function driveHeadlessOidc(ctx, authUrl, listener) {
 ...
 */
async function headlessLogin(ctx, meta, client, listener, opts = {}) {
    const pkce = (0, authCode_js_1.generatePkce)();
    const state = (0, node_crypto_1.randomBytes)(16).toString("base64url");
    const authUrl = (0, authCode_js_1.buildAuthorizationUrl)({
        meta,
        client,
    ...
    return (0, authCode_js_1.exchangeCode)({
        meta,
        client,
        redirectUri: listener.redirectUri,
        code,
