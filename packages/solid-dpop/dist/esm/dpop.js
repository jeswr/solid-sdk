 ...
 */
export function canonicalHtu(uri) {
    const u = new URL(uri);
    u.search = "";
    u.hash = "";
    return u.toString();
...
export async function toDpopKeyPair(publicKey, privateKey) {
 ...
 */
export async function exportDpopKeyPairJwk(keyPair) {
 ...
 */
export async function importDpopKeyPairJwk(jwk) {
    if (!jwk.d) {
