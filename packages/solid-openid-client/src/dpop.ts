...
import { createDpopProof, type DpopKeyPair, generateDpopKeyPair } from "@jeswr/solid-dpop";
...
export function toCryptoKeyPair(keyPair: DpopKeyPair): CryptoKeyPairLike {
 ...
 */
export function resourceDpopProof(
  keyPair: DpopKeyPair,
  method: string,
  url: string,
  accessToken: string,
