 ...
 */
export async function dpopBoundRequest(request, accessToken, dpop) {
    const headers = new Headers(request.headers);
    await oauth.protectedResourceRequest(accessToken, request.method, new URL(request.url), undefined, undefined, {
        DPoP: dpop,
...
//# sourceMappingURL=dpopBoundRequest.js.map