...
export type { AuthenticatedFetch, RegisterPasskeyOptions, RegisterPasskeyResult, } from "./client/registration.js";
export { registerPasskey } from "./client/registration.js";
export type { TokenExchange, TokenExchangeContext, TokenProvider, } from "./client/TokenProvider.js";
export type { WebAuthnConfig, WebAuthnIssuerConfig, } from "./client/WebAuthnTokenExchange.js";
...
export type { AssertionBundle, AssertionOptions, AuthenticationResponseJSON, PublicKeyCredentialCreationOptionsJSON, PublicKeyCredentialRequestOptionsJSON, RegistrationBundle, RegistrationOptions, RegistrationResponseJSON, } from "./protocol/index.js";
export { allowedOriginsFor, BUNDLE_VERSION, decodeAssertionBundle, decodeBase64url, encodeAssertionBundle, encodeBase64url, isAllowedOrigin, MalformedBundleError, normaliseOrigin, TOKEN_EXCHANGE_GRANT_TYPE, WEBAUTHN_ASSERTION_TOKEN_TYPE, } from "./protocol/index.js";
