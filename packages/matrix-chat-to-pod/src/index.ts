...
// Re-export the canonical message type from the chat-interop hub so consumers can
// type the transform output without a second import.
export type { CanonicalMessage } from "@jeswr/solid-chat-interop";
// --- the import orchestration + owner-only ACL builder ---
export {
  buildOwnerOnlyAclTurtle,
  type ImportRoomOptions,
  type ImportRoomResult,
  importRoom,
} from "./import.js";
// --- Matrix wire types (untrusted CS-API event shapes) ---
export type {
  MatrixEvent,
  MatrixInReplyTo,
